...
Credits to the oringal Jekyll version of the "Forty" theme by [HTML5 UP](https://html5up.net/). I've made further improvements and some more features.

# Added Features

* Add search bar for navigation
* Add Unsplash pictures support
* Add [markmap-cli](https://github.com/gera2ld/markmap/tree/master/packages/markmap-cli) supoort using github actions
